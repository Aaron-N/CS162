/*********************************************************************
** Program name:  Lab 6 (input_validation.cpp)
** Author:        Aaron Nesbit
** Date:          11/5/19
...
/*
* Summary:  int_validate_9_choice() - this is the input validation
*           function for the 9-choice menu
* Returns:  validated user-entered integer
*/
int int_validate_9_choice()
{
   string input;
   int validated_input;
   do
   {
      do
      {
         ...
         {
            cout << "Invalid input! Selection range is 1 through 9!"
                 << " Try again!" << endl;
            cin.clear();
         }
      ...
      if(validated_input < 1 || validated_input > 9)
      {
         cout << "Invalid input! Selection range is 1 through 9!"
              << " Try again!" << endl;
      }      

   }while(validated_input < 1 || validated_input > 9);
